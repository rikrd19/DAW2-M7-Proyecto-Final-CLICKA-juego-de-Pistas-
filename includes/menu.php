  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarMain">
      ...
      <ul class="navbar-nav ms-auto align-items-center gap-2">
        ...
        <?php else: ?>
          <li class="nav-item nav-auth-guest d-flex flex-wrap gap-2 align-items-center justify-content-lg-end w-100 w-lg-auto">
            <a class="btn btn-outline-accent btn-sm px-3 nav-auth-btn flex-fill flex-lg-grow-0" href="<?php echo BASE_URL; ?>/pages/register.php">
              Registrarse
            </a>
            <a class="btn btn-outline-accent btn-sm px-3 nav-auth-btn flex-fill flex-lg-grow-0" href="<?php echo BASE_URL; ?>/pages/login.php">
              Iniciar sesión
            </a>
          </li>
        <?php endif; ?>
