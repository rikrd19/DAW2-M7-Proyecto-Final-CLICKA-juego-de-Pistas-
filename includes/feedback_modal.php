    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content border-0 shadow">
        <div class="modal-header">
          <h5 class="modal-title" id="modal-feedback-label">¿Te gustó?</h5>
        </div>
        <div class="modal-body">
          <p class="mb-3 fs-5 fw-semibold text-dark" id="modal-feedback-lead" hidden></p>
          <p id="feedback-validation-msg" class="small text-danger mb-2" hidden></p>
          <p id="feedback-login-notice" class="mb-0 fs-5 fw-semibold text-dark" hidden>
            Ayúdanos a mejorar las pistas.
            <a href="<?php echo BASE_URL; ?>/pages/register.php">Regístrate</a>
            o
            <a href="<?php echo BASE_URL; ?>/pages/login.php">inicia sesión</a>.
          </p>
        ...
        <div class="modal-footer flex-wrap gap-2">
          <button type="button" class="btn btn-accent" id="btn-feedback-skip" data-bs-dismiss="modal">Omitir</button>
